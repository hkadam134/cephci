...
def run(ceph_cluster, **kw):
    ...
    try:
        ...
        fs_scale_utils.collect_logs(
            ceph_cluster, clients, default_fs, fs_scale_utils, fs_util_v1, log_dir
        )
        ...
        fs_scale_utils.collect_and_compress_logs(clients[0], fs_util_v1, log_dir)
        ...
        fs_system_utils.crash_check(client, crash_copy=1, daemon_list=daemon_list)
